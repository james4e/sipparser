...
func TestAccept(t *testing.T) {
	...
	if sm.Accept.Params[0].Type != "application" {
		t.Errorf("[TestAccept] Error parsing accept hdr: application/sdp.  sm.Accept.Params[0].Type should be \"application\".  Received:", sm.Accept.Params[0].Type)
	}
	if sm.Accept.Params[0].Val != "sdp" {
		t.Errorf("[TestAccept] Error parsing accept hdr: application/sdp.  sm.Accept.Params[0].Val should be \"sdp\" but received:", sm.Accept.Params[0].Val)
	}
}
