...
func parseRpidGetUri(r *RemotePartyId) parseRpidStateFn {
	...
	if r.URI.Error != nil {
	    r.Error = os.NewError("parseRpidGetUri err: received err getting uri: " + r.URI.Error.String())
	    return nil
	}
	return parseRpidGetParams
    }
    r.Error = os.NewError("parseRpidGetUri err: could not locate bracks.  no uri found.")
    return nil 
}
